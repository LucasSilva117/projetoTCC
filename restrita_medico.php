  ...
  <div class="container-lg mt-3">
    ...
    <ul class="nav nav-tabs mb-3" id="listasTab" role="tablist">
      <li class="nav-item" role="presentation">
        <button class="nav-link active" id="consultorio-tab" data-bs-toggle="tab" data-bs-target="#tabConsultorio" type="button" role="tab">
          Lista do consultório
        </button>
      </li>

      <li class="nav-item" role="presentation">
        <button class="nav-link" id="triagem-tab" data-bs-toggle="tab" data-bs-target="#tabTriagem" type="button" role="tab">
          Lista da triagem
        </button>
      </li>
    </ul>
    ...
    <div class="tab-content" id="listasTabContent">
      <!-- ===================================== -->
      <!--  ABA 1 – LISTA DE ESPERA CONSULTÓRIO -->
      <!-- ===================================== -->
      <div class="tab-pane fade show active " id="tabConsultorio" role="tabpanel">
          ...
          <div class="card-body">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                $sql = "SELECT a.*, p.*, e.*, t.*, m.nomeM FROM
                atendimentos a 
                    ...
                    <tr>
                      ...
                      <td>
                        <form action="acoespacientes.php" method="post" class="d-inline">
                          <button onclick="return confirm('Tem certeza que deseja excluir esse atendimento?')" type="submit" name="excluir_atendimentoT" value="<?= $atendimento['codAten'] ?>" class="btn btn-danger btn-sm">
                            Excluir
                          </button>
                        </form>
      ...
      <!-- ========================== -->
      <!--  ABA 2 – LISTA DE TRIAGEM -->
      <!-- ========================== -->
      <div class="tab-pane fade" id="tabTriagem" role="tabpanel">
