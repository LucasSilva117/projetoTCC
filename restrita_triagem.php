  ...
  <nav class="navbar navbar-dark bg-dark">
    <div class="container-md d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex align-items-center">
        ...
        <h1 style="color: white; margin: 0 0 0 10px;">Triagem</h1>
      </div>
                ...
                <tr>
                  ...
                  <td>
                    <form action="acoespacientes.php" method="post" class="d-inline">
                      <button onclick="return confirm('Tem certeza que deseja excluir esse atendimento?')" type="submit" name="excluir_atendimento" value="<?= $atendimento['codAten'] ?>" class="btn btn-danger btn-sm">Excluir</button>
                    </form>
