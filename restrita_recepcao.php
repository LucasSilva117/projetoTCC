...
<body>
  ...
  <nav class="navbar navbar-dark bg-dark">
    <div class="container-md d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex align-items-center">
        ...
        <h1 style="color: white; margin: 0 0 0 10px;">Recepção</h1>
      </div>
  ...
  <div class="container-lg">
    <div class="mx-2 my-1">
      ...
      <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#pesquisaModal">Adicionar Paciente à lista</button>
          ...
          <div class="card-body">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                WHERE a.situacao IN ('Esperando', 'Na triagem')
  ...
  <script>
    document.getElementById('btnBuscar').addEventListener('click', function() {
      ...
      fetch('buscar_paciente.php?cpf=' + cpf)
        ...
        .then(data => {
          console.log(data);
          var tbody = document.querySelector('#resultadoBusca tbody');
          tbody.innerHTML = '';
